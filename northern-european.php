            ...
            <div class="row">
                <div class="col-xl-9 col-12">
                    ...
                    <div class="breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a>Northern European Service (NWC)</a></li>
                    ...
                    <div class="general-content border-2">
                        ...
                        <!--Stop watch başladı.-->
                        <h1 class="searchTitle">Northern European Service (NWC)</h1>
                        <div class="border-4 border-bottom pt-4 mb-4"></div>
                        <div class="mt-4 text-secondary fst-italic fs-5">
                        </div>
                        <div class="col-12 mt-5">

                            <img src=" assets/images/services/kuzeyavrupaservisiharita.jpg"
                        ...
                        <div class="col-12 mt-5 text-secondary">
                            <div class="searchContent">
                                ...
                                <ul>
                                    <li>Weekly, direct Türkiye-North Europe Service with short transit times</li>
                                    <li>Odessa and Constanta connection via Istanbul&nbsp;(*Odessa suspended.)</li>
                                    <li>Connections to Mersin and major East Mediterranean port</li>
                                </ul>
                                ...
                                <table class="custom-table">
                                    <tbody>
                                        <tr>
                                            ...
                                            <th><strong>Piraeus&nbsp;</strong></th>
                                            <th><strong>Izmit/Gebze</strong></th>
                                            <th><strong>Istanbul</strong></th>
                                            <th><strong>Gemlik</strong></th>
                                            <th><strong>Izmir</strong></th>
                                        </tr>
                                        <tr>
                                            <th><strong>Felixstowe</strong></th>
                                            <td>16</td>
                                            <td>18</td>
                                            <td>20</td>
                                            <td>21</td>
                                        ...
                                        <tr>
                                            <th><strong>Bremerhaven</strong></th>
                                            <td>12</td>
                                            <td>14</td>
                                            <td>16</td>
                                            <td>17</td>
                                ...
                                <table class="custom-table">
                                    <tbody>
                                        <tr>
                                            <th style="width: 127px; height: 55px;"><strong>WestBound</strong></th>
                                            <th><strong>Valencia</strong></th>
                                            <th><strong>Felixstowe</strong></th>
                                            <th><strong>Hamburg</strong></th>
                                            <th><strong>Bremerhaven</strong></th>
                                            <th><strong>Antwerp</strong></th>
                        ...
                        <div class="my-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-6 padding-card">
                                    <div class="card mb-3 custom-card">
                                        <div class="card-body bg-light rounded-2 w-100 padding-card">
                                            <p class="fs-12">Northern European Service (NWC) Flyer</p>
                                            <a href="#" class="card-link" aria-label="link" target="_blank"><i
                                                    class="fa fa-arrow-down text-danger"></i></a>
                                        </div>
                                    </div>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-4 col-12 mb-4">
                                <div class="card-container">
                                    <div class="grad1">
                                        <a href="#"><span class="centered-text">Ukraine &amp; Romania Service
                                                (TUR)</span></a>
                                    </div>
                                    <img class="card-img"
...
Turkon Line CEO Alkın&nbsp;Kalkavan drew attention to Turkey's records in export and said, "We think that our proximity to important markets and our product and service quality are effective in our country breaking records in export almost every month in 2022." said.                        </p>
                    </div>
