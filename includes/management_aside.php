<div class="col-3 d-none d-xl-block border-start">
    ...
    <div class="ml-md-3 aside text-secondary">
        ...
        <div class="d-flex flex-column">
            ...
            <a href="/en/corporate/certificates/management-system-certificates" target=""
                class="aside-link text-secondary ps-2 pt-2 active  "> <i
                    class="ms-icon ms-icon-forward text-danger"></i> Management System Certificates</a>

            <a href="/en/corporate/certificates/service-certificates" target=""
                class="aside-link text-secondary ps-2 pt-2   "> <i class="ms-icon ms-icon-forward text-danger"></i>
                Service Certificates</a>
